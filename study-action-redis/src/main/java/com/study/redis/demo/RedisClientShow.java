/**
 * 
 * File: RedisClient.java <br/>
 * Package: com.study.redis <br/>
 * Description:TODO(用一句话描述该文件做什么) <br/>
 * @author zhengxy
 * @Date 2018年10月26日 下午1:48:41
 * @version 1.0
 * 
 */
 ...
 * 
 */
public class RedisClientShow {
    private Jedis            jedis;           // 非分布式客户端连接
    private JedisPool        jedisPool;       // 非分布式连接池
    private ShardedJedis     shardedJedis;    // 分布式客户端连接
    private ShardedJedisPool shardedJedisPool;// 分布式连接池
    
    public RedisClientShow() {
        initialPool();
        initialShardedPool();
    ...
    private void initialPool() {
        ...
        jedisPool = new JedisPool(config, "127.0.0.1", 10001);
    }
    ...
    private void initialShardedPool() {
        ...
        shards.add(new JedisShardInfo("127.0.0.1", 10001, "master"));
        /*
         * JedisShardInfo slave1 = new JedisShardInfo("127.0.0.1", 10001,
         * "master"); slave1.setPassword("slave123"); shards.add(slave1);
         */
    ...
    public void showSortedSetOperate() {
