...
import com.study.netty.tcp.demo2.client.echo.EchoHandler_3_0;
 ...
 * @version 1.0
 */
public class TcpClient_3_0 {
    private String ip;
    private int port;

    public TcpClient_3_0(String ip, int port) {
        this.ip = ip;
        this.port = port;
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        new TcpClient_3_0("127.0.0.1", 10003).init();
    }
}
